...
cc('data-hub-storage.routes.dataHub', () =>
  `${cfg.routes.dataHubs}/:dataHubId`);
cc('data-hub-storage.routes.documents', () =>
  `${cfg.routes.dataHub}/documents`);
cc('data-hub-storage.routes.document', () =>
  `${cfg.routes.dataHub}/documents/:docId`);
cc('data-hub-storage.routes.query', () =>
  `${cfg.routes.dataHub}/query`);
